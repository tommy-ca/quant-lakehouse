...
| s5cmd optional for archive downloads | `archive/s5cmd_download.py` | Fast parallel S3 download via s5cmd run (command file) | Pass `use_s5cmd=True` to archive_data_resource. Requires s5cmd installed. Falls back to aiohttp. |
